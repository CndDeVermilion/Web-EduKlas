...
<html lang="en">
  <head>
    ...
    <title>Data Siswa - EduKlas</title>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="card">
  <div class="card-body">
    <h4 class="card-title">Daftar Akun Siswa</h4>
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>
                    ...
                    <td>{$row['username']}</td>
                    <td>
                      <a href='edit_siswa.php?id={$row['id_siswa']}' class='btn btn-warning btn-sm'>Edit</a>
                      <a href='hapus_siswa.php?id={$row['id_siswa']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Yakin ingin menghapus akun ini?')\">Hapus</a>
                    </td>
                  </tr>";
            $no++;
          }
