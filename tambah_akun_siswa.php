...
<html lang="en">
  <head>
    ...
    <title>Tambah Guru - EduKlas</title>
      ...
      <div class="container-fluid page-body-wrapper">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    ...
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php echo $nama_lengkap; ?></p>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Form Tambah Akun Siswa</h4>
                    <form action="proses_tambah_siswa.php" method="POST" class="forms-sample">
