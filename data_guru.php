        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="card">
  <div class="card-body">
    <h4 class="card-title">Daftar Akun Guru</h4>
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>
                    ...
                    <td>
                      ...
                      <a href='hapus_guru.php?id={$row['id_guru']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Yakin ingin menghapus akun ini?')\">Hapus</a>
                    </td>
                  </tr>";
            $no++;
          }
