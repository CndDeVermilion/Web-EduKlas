...
<html lang="en">
  <head>
    ...
    <title>Dashboard Siswa - EduKlas</title>
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Hai <?php echo $nama; ?>,Selamat Datang di EduKlas</h4>
                    <p class="card-description">Berikut adalah ringkasan informasi untuk kamu</p>
                  </div>
                </div>
              </div>
            </div>
